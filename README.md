...
- **FLARE:** Throttle is cut, and the plane targets a pitch angle of LAND_PITCH_DEG and a roll angle of 0. When the gyroscopes observe no motion for 10 seconds, the plane switches to TOUCHDOWN mode.
